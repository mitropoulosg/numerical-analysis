...
% Max eigenvalue
t1 = tic;
fprintf("\n\n                        Calculation of (λ1,x(1)) - Inverse Power Method\n");
fprintf("==========================================================================================================\n");
fprintf("Shift q      Number of       Maximum               Εigenvector x^(1)\n");
fprintf("            iterations   abs. eigenvalue\n");
fprintf("----------------------------------------------------------------------------------------------------------\n");
...
% Min eigenvalue
fprintf("\n\n                        Calculation of (λ%d,x(%d)) - Inverse Power Method\n", n, n);
fprintf("==========================================================================================================\n");
fprintf("Shift q      Number of       Minimum               Εigenvector x^(%d)\n", n);
fprintf("            iterations   abs. eigenvalue\n");
fprintf("----------------------------------------------------------------------------------------------------------\n");
